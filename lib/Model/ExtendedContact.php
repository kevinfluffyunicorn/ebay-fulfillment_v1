...
class ExtendedContact implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets full_name
     *
     * @param string|null $full_name The full name of the buyer or eBay shipping partner.<br><br><span class=\"tablenote\"><strong>Note:</strong> The <b>fullName</b> will not be returned for any order that is more than 90 days old.</span>
     *
     * @return self
     */
